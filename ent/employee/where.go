...
func HospitalID(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HospitalIDEQ(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
		s.Where(sql.EQ(s.C(FieldHospitalID), v))
	})
}
...
func HospitalIDNEQ(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HospitalIDIn(vs ...int) predicate.Employee {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func HospitalIDNotIn(vs ...int) predicate.Employee {
	v := make([]interface{}, len(vs))
	for i := range v {
		v[i] = vs[i]
	}
...
func HospitalIDGT(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HospitalIDGTE(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HospitalIDLT(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
...
func HospitalIDLTE(v int) predicate.Employee {
	return predicate.Employee(func(s *sql.Selector) {
